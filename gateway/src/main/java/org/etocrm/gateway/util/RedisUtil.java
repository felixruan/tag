package org.etocrm.gateway.util;
...
public class RedisUtil {
    ...
    public boolean lSet(String key, Object value) {
        try {
            ...
            log.error("class:RedisUtils method:lSet(k,v) => Exception {}", e.getMessage());
        }
        return false;
    }
    ...
    public boolean lSet(String key, Object value, long time) {
        try {
            ...
            log.error("class:RedisUtils method:lSet(k,v,time) => Exception {}", e.getMessage());
        }
        return false;
    }
    ...
    public boolean lSet(String key, List<Object> value) {
        try {
            ...
            log.error("class:RedisUtils method:lSet(k,lv) => Exception {}", e.getMessage());
        }
        return false;
    }
    ...
    public boolean lSet(String key, List<Object> value, long time) {
        try {
            ...
            log.error("class:RedisUtils method:lSet(k,lv,time) => Exception {}", e.getMessage());
        }
        return false;
    }
