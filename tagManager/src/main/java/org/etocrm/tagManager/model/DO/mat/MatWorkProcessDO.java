 ...
 * Create By peter.li
 */
@ApiModel(value = "自动化营销流程DO")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Accessors(chain = true)
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@TableName("mat_map_works")
public class MatWorkProcessDO extends BasePojo implements Serializable {

    private static final long serialVersionUID = 4773040466475711876L;
    /**
     * 主键id
     */
    ...
    /** mat流程id */
    @ApiModelProperty(value = "mat流程id")
    private Long matId ;
