...
@TableName("mat_event_property")
public class MetadataPropertyDO extends BasePojo implements Serializable {

    private static final long serialVersionUID = -7684973529464945001L;
