...
public class SysTagPropertyRuleLogicalOperationResponseVO implements Serializable {

    private static final long serialVersionUID = -5393738031546881657L;

    @ApiModelProperty(value = "条件运算关系id")
    private Long id;
    ...
    @ApiModelProperty(value = "条件运算关系名称")
    private String name;
    ...
    private SysTagPropertyRuleLogicalOperationResponseVO child;//
