...
@Data
public class SysTagGroupRuleGetResponseVO implements Serializable {


    private static final long serialVersionUID = 5001017262797802068L;
    ...
    private List<SysTagGroupRuleResponseVO> rule;
