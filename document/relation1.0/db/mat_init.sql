/*
 ...
 Source Server         : 10.100.20.112
 Source Server Type    : MySQL
 Source Server Version : 80021
 Source Host           : 10.100.20.112:3306
 Source Schema         : tag_dev

 Target Server Type    : MySQL
 Target Server Version : 80021
 File Encoding         : 65001

 Date: 12/02/2020 18:14:32
*/
...
CREATE TABLE `mat_automation_visit_auth_records` (
  ...
  `delete_time` datetime DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=30002 COMMENT='自动化营销访问授权记录表 ';
...
CREATE TABLE `mat_event_reporting_data` (
  ...
  `delete_time` datetime DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=124476 COMMENT='MAT事件上报表 ';
...
CREATE TABLE `mat_map_calculation_data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=180001 COMMENT='自动化营销计算人群结果数据表 ';
...
CREATE TABLE `mat_map_work_handles` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=60001 COMMENT='自动化营销流程人群处理类型表 ';
...
CREATE TABLE `mat_map_works` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=129120 COMMENT='自动化营销流程表 ';
...
CREATE TABLE `mat_map_works_actions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=60001 COMMENT='自动化营销流程每种处理支线要发送的内容表 ';
